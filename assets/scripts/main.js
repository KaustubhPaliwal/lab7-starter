...
function getRecipesFromStorage() {
	// A9. Get 'recipes' from localStorage and parse them into an array.
...
function initFormHandler() {
	...
	form.addEventListener('submit', event => {
		...
		// B5. Create an empty object (we'll refer to this object as recipeObject)
		// and then extract the keys and corresponding values from the FormData object
		// and insert them into recipeObject
		const recipeObject = {};
